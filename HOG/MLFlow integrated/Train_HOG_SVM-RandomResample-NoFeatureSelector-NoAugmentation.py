...
run_name = "DS2-HOG-SVM-RandomResample-NoFeatureSelector-NoAugmentation"
...
# Dataset paths
dataset_path = r"D:\AI stuff\CV-LEC-FinalProject\Datasets\HardHatWorkers-cropped"
...
train_data, train_labels = load_images_from_annotations(annotations, "train")
val_data, val_labels = load_images_from_annotations(annotations, "valid")
