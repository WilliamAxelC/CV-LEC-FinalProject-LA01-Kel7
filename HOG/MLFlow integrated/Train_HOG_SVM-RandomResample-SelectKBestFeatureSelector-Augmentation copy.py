...
run_name = "HOG-SVM-RandomResample-Select1500KBestFeatureSelector-Augmentation"
...
feature_selector = SelectKBest(f_classif, k=1500)
...
with mlflow.start_run(run_name=run_name):
    ...
    mlflow.log_artifact(feature_selector_path)
